...
if __name__ == '__main__':
    ...
    dataset = np.delete(dataset, col_index, 1)
    ...
    classifier = RandomForestClassifier(n_estimators=tree_number, criterion=criterium, random_state=0)
    classifier.fit(X, Y)
    ...
    predict_proba = classifier.predict_proba(entry)
