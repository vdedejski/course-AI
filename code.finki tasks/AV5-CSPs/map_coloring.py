...
if __name__ == '__main__':
    ...
    problem.addVariables(["WA", "NT", "SA", "Q", "NSW", "V", "T"],
                         ["red", "green", "blue"])
    ...
    solution = problem.getSolution() # Dictionary for every solution
    print(len(solution)) # No. solutions
    print(solution)

    #MinSolution => only one solution
