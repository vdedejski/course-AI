from searchingframework.utils import Problem
from searchingframework.informed_search import greedy_best_first_graph_search, astar_search, recursive_best_first_search
...
class Puzzle(Problem):
    ...
    def succesor(self, state):
        ...
        ind = state.index('*')  # Index na pojavuvanje na dadaden element
        if ind >= 3:
            tmp = list(state)
    ...
    def h(self, node):
        counter = 0  # Broj na polinja koj ne se na vistinsko mesto
